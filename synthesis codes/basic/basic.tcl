# 
# Project automation script for basic 
# 
# Created for ISE version 14.7
# 
# This file contains several Tcl procedures (procs) that you can use to automate
# your project by running from xtclsh or the Project Navigator Tcl console.
# If you load this file (using the Tcl command: source basic.tcl), then you can
...
proc add_source_files {} {
   ...
   xfile add "tb_vedic3bit.v"
   xfile add "vedic3bit.v"

   # Set the Top Module as well...
   project set top "tb_vedic3bit"
...
proc set_process_props {} {
   ...
   project set "Work Directory" "D:/synthesis codes/basic/xst" -process "Synthesize - XST"
   ...
   project set "Output File Name" "tb_vedic3bit" -process "Generate IBIS Model"
